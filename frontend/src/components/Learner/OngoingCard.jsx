      ...
      <div className="p-6">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full mt-4 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-indigo-100 active:scale-95 transition-all"
          >
