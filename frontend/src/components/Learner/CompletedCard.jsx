...
import { 
  BookOpen, CheckCircle, Award, PlayCircle, 
  FileText, Search, MoreVertical, ArrowRight 
} from 'lucide-react';
...
const CompletedCard = ({ course }) => (
  <div className="bg-white p-5 rounded-2xl border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:shadow-sm transition-all group">
    <div className="flex items-center gap-4">
      ...
      <div>
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <span className="text-xs text-gray-400">on {course.completionDate}</span>
        </div>
      </div>
    </div>
    <div className="flex gap-3">
      ...
      <button className="flex-1 md:flex-none px-5 py-2.5 bg-slate-50 text-indigo-600 rounded-xl font-bold text-sm hover:bg-indigo-50 flex items-center justify-center gap-2">
