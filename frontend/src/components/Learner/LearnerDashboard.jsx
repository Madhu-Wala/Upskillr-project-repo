...
const THEME_CONFIG = {
  stats: [
    // Removed the blue theme used for Hours Learned
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
          {statsData.map((item, index) => (
            <StatCard key={item.id} item={item} theme={THEME_CONFIG.stats[index % 3]} />
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="lg:col-span-2 space-y-6">
            ...
            {learningData.length > 0 ? (
              ...
              <p className="text-gray-400 italic">You haven't started any courses yet.</p>
            )}
          </div>
          ...
          <div className="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm h-fit">
            ...
            <AchievementRow 
              ...
              theme={{ bg: "bg-blue-50", text: "text-blue-600", iconBg: "bg-blue-100" }} 
            />
          </div>
        </div>
